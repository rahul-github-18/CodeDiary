...
/**
 * Generates and downloads a clean, elegant landscape PDF certificate of completion.
 */
export const generateCertificatePDF = async ({
  ...
  try {
    ...
    doc.text("CODEDIARY LEARNING ACADEMY", centerX, headerY, { align: 'center' });
    headerY += 10;
    ...
    // Subtitle Line / Gold Accent Line
    doc.setDrawColor(217, 119, 6);
    doc.setLineWidth(0.8);
    ...
    doc.setFontSize(5.5);
    doc.text("CODEDIARY", sealX, sealY + 2.5, { align: 'center' });
    doc.text("CERTIFIED", sealX, sealY + 6.5, { align: 'center' });
    ...
    const safeTitle = (courseTitle || 'Course').replace(/[^a-zA-Z0-9_\-]/g, '_');
