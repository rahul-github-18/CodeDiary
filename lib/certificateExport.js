...
export const generateCertificatePDF = async ({
  ...
  try {
    ...
    const verifyUrl = `https://codediary.com/verify/${certId}`;
    ...
    doc.setFontSize(7.5);
    doc.setTextColor(...colorNavy);
    const metaStr = `Category: ${category}   |   Difficulty: ${difficulty}   |   Lessons Completed: ${lessonsCount}   |   Coding Problems Solved: ${problemsCount}   |   Final Assessment: Passed   |   Status: 100%`;
    ...
    doc.setFontSize(7.5);
    doc.setTextColor(...colorTextMuted);
    const contactStr = "Website: https://codediary.com   •   LinkedIn: https://linkedin.com/company/codediary   •   Email: support@codediary.com";
